...
# local
RES=$(curl -X POST -H "Content-Type: application/json" -H "Authorization: token aad91b00-cfc5-4b4e-be59-af139ec92766" --data '{"commit": "f9ef27dcb8e5bb355e2c2eddbd243930abe7c372", "slug": "JerrySentry::::codecov-test"}' http://localhost:8000/upload/bundle_analysis/v1)
echo $RES
