...
# local huh 3
RES=$(curl -X POST -H "Content-Type: application/json" -H "Authorization: token 0418a9ad-f46d-4dd6-9111-b99cdb0b0aa8" --data '{"branch": "main", "commit": "7081cfbdcd746a5a3b9a82f0ffeaa4638e10890c", "slug": "JerrySentry::::LocalDev"}' http://localhost:8000/upload/bundle_analysis/v1)
...
curl -v --upload-file bundle-super-2.json $URL
