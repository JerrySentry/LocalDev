...
# LocalDev
RES=$(curl --location --request POST 'http://localhost:8000/upload/v4?branch=main&commit=b855589326202a8adacf5325d5413fde3fbc0fbe&token=aad91b00-cfc5-4b4e-be59-af139ec92766&slug=codecov%2FLocalDev')
